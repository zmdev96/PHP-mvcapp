...
@section('content_css')
<link href="{{DASHBOARD_VENDOR}}datatables/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css" />
<link href="{{DASHBOARD_VENDOR}}datatables/buttons/css/buttons.bootstrap4.min.css" rel="stylesheet" type="text/css" />
@endsection
...
<div class="card shadow mb-4">
  ...
  <div class="card-header  d-flex flex-row align-items-center justify-content-between">
    ...
    <div class="card-action">
      <button class="action-item  delete btn btn-danger btn-sm disabled"> <i class="fas fa-trash fa-fw"></i></button>
      <a class="action-item  btn btn-primary btn-sm" href="{{$this->url('app-admin/users/create')}}"> <i class="fas fa-user-plus fa-fw"></i></a>
      <button class="action-item  reload btn btn-success btn-sm" > <i class="fas fa-sync-alt fa-fw"></i></button>
      <button class="action-item  filter btn btn-info btn-sm " type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> <i class="fas fa-filter fa-fw"></i></button>
      <button class="action-item  option btn btn-secondary btn-sm" > <i class="fas fa-ellipsis-v fa-fw"></i></button>
...
<!-- JS Footer Resources -->
@section('content_js')
<script src="{{DASHBOARD_VENDOR}}datatables/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/dataTables.bootstrap4.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/buttons/js/dataTables.buttons.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/buttons/js/buttons.bootstrap4.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/jszip/jszip.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/pdfmake/pdfmake.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/pdfmake/vfs_fonts.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/buttons/js/buttons.html5.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/buttons/js/buttons.print.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/buttons/js/buttons.colVis.min.js" type="text/javascript"></script>
<script src="{{DASHBOARD_VENDOR}}datatables/datatable.config.js" type="text/javascript"></script>
<script type="text/javascript">
  $('.card .card-action .reload').click(function(e) {
    e.preventDefault();
    $('.card .overflow').css('display', 'flex');
    $.ajax({
      url: "http://mvcapp.work/app-admin/users",
      method: "post",
      data: {
    ...
    function playSound() {
      let src = 'http://mvcapp.work/dist/dashboard/sound/nokia_x_msg.mp3';
